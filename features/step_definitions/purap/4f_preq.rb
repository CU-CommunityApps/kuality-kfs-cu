...
And(/^I Select the REQS and Enter a Contract Manager$/) do
  pending # express the regexp above with the code you wish you had
end



And(/^I Submit the document and it goes FINAL$/) do
  pending # express the regexp above with the code you wish you had
end

And(/^I login as the REQS Initiator$/) do
  pending # express the regexp above with the code you wish you had
end



And(/^The REQS Status is$/) do
  pending # express the regexp above with the code you wish you had
end
...
And(/^I search and retrieve the Requisition\$/) do
